...
// mimic `enigma_1`
//   generated at runtime using `window.keplr.getEnigmaUtils('dummy-1').constructor.toString()`
const o = class{constructor(t,e){this.chainId=t,this.keplr=e}getPubkey(){return n(this,void 0,void 0,(function*(){return yield this.keplr.getEnigmaPubKey(this.chainId)}))}getTxEncryptionKey(t){return n(this,void 0,void 0,(function*(){return yield this.keplr.getEnigmaTxEncryptionKey(this.chainId,t)}))}encrypt(t,e){return n(this,void 0,void 0,(function*(){return yield this.keplr.enigmaEncrypt(this.chainId,t,e)}))}decrypt(t,e){return n(this,void 0,void 0,(function*(){return yield this.keplr.enigmaDecrypt(this.chainId,t,e)}))}};

// mimi `cosmos_1.CosmJSOfflineSignerOnlyAmino`
//   generated at runtime using `window.keplr.CosmJSOfflineSignerOnlyAmino('dummy-1').constructor.toString()`
...
const u = {
	...
	//   generated at runtime using `window.keplr.getOfflineSigner('dummy-1').constructor.toString()`
